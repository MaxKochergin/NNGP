...
function EmployerProfileExperience() {
  ...
  const [experiences, setExperiences] = useState<WorkExperience[]>([
    {
      id: '1',
      company: 'ООО "Городские Проекты"',
      position: 'Инженер-конструктор ПГС',
      description:
        'Проектирование железобетонных конструкций жилых комплексов (серия ЖК "Зелёный город"). Расчет конструктивных элементов в ЛИРА-САПР и SCAD, разработка узлов усиления. Подготовка документации для прохождения государственной экспертизы. Трёхмерное моделирование каркасов зданий в Revit.',
      startDate: new Date('2018-05-01'),
      endDate: new Date('2021-09-30'),
      skills: ['Железобетонные конструкции', 'ЛИРА-САПР', 'SCAD', 'Revit', 'Расчет конструкций'],
    },
    {
      id: '2',
      company: 'АО "СК Модерн"',
      position: 'Ведущий инженер-конструктор',
      description:
        'Руководство проектной группой из 5 специалистов. Проектирование монолитных железобетонных конструкций для высотных зданий (22-30 этажей). Выполнение расчетов на сейсмические воздействия. Разработка технических решений по усилению несущих конструкций. Участие в авторском надзоре. Внедрение BIM-технологий в работу отдела.',
...
export default EmployerProfileExperience;
