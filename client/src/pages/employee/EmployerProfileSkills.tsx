...
function EmployerProfileSkills() {
  ...
  const [skills, setSkills] = useState<Skill[]>([
    {
      ...
      yearsOfExperience: 5,
      description:
        'Комплексный расчет монолитных железобетонных конструкций. Создание расчетных схем, анализ результатов, подбор армирования. Опыт расчета на прогрессирующее обрушение и сейсмические воздействия.',
      category: 'hard',
    },
    {
      id: '2',
      ...
      yearsOfExperience: 4,
      description:
        'BIM-моделирование каркасов зданий, создание семейств для железобетонных конструкций, подготовка документации, координация с разделами АР и ИОС. Опыт внедрения BIM-процессов в проектном отделе.',
      category: 'hard',
    },
    {
      id: '3',
      ...
      description:
        'Владение техническим английским на уровне B2. Чтение нормативных документов, технических спецификаций. Переписка с иностранными партнерами, проведение презентаций проектов на английском языке.',
      category: 'language',
    },
    {
      id: '4',
      ...
      yearsOfExperience: 3,
      description:
        'Руководство проектной группой из 5 человек. Планирование работ, распределение задач, контроль качества. Опыт взаимодействия с заказчиками, подрядчиками и экспертизой. Координация смежных разделов.',
      category: 'soft',
    },
    {
      id: '5',
      name: 'Проектирование монолитных железобетонных конструкций',
      level: 5,
      yearsOfExperience: 7,
      description:
        'Проектирование несущих систем многоэтажных жилых и общественных зданий. Проектирование узлов, схем армирования. Разработка конструктивных решений фундаментов, каркасов, перекрытий. Опыт проектирования высотных зданий до 30 этажей.',
      category: 'hard',
    },
    {
      id: '6',
      ...
      yearsOfExperience: 4,
      description:
        'Моделирование и расчет несущих конструкций, анализ напряженно-деформированного состояния, расчет узлов металлоконструкций. Расчет на динамические воздействия.',
      category: 'hard',
    },
    {
      id: '7',
      ...
      yearsOfExperience: 7,
      description:
        'Разработка полного комплекта рабочей документации по железобетонным и металлическим конструкциям. Создание детальных узлов, разработка схем армирования, спецификаций арматуры и закладных изделий.',
      category: 'hard',
    },
  ]);
...
export default EmployerProfileSkills;
