...
const mockNotifications: Notification[] = [
  {
    id: '1',
    title: 'Доступен новый материал',
    message:
      'Для вас добавлен материал по железобетонным конструкциям в разделе "Учебные материалы"',
    type: 'info',
    timestamp: '2025-04-01T10:30:00',
    isRead: false,
    link: '/app/employee/learning-materials',
    category: 'system',
  },
  {
    id: '2',
    title: 'Тест по основам расчета конструкций',
    message: 'Вы прошли тест "Основы расчета конструкций" с результатом 72%',
    type: 'success',
    timestamp: '2025-04-08T14:15:00',
    isRead: true,
    link: '/app/employee/completed-test',
    category: 'test',
  },
  {
    id: '3',
    title: 'Обновите данные специализации',
    message: 'Для правильного подбора материалов уточните вашу основную специализацию в профиле',
    type: 'warning',
    timestamp: '2025-04-05T09:00:00',
    isRead: false,
    link: '/app/employee/profile',
    category: 'profile',
  },
  {
    id: '4',
    title: 'Обновление учебных материалов',
    message: 'В раздел "Учебные материалы" добавлены статьи по инженерным системам ОВ и ВК',
    type: 'info',
  ...
  },
  {
    ...
    message:
      'Назначен корпоративный тест по железобетонным конструкциям. Рекомендуем пройти в ближайшее время.',
    type: 'warning',
    timestamp: '2025-04-12T11:30:00',
    isRead: false,
    link: '/app/employee/available-tests',
    category: 'test',
  },
  {
    id: '6',
    title: 'Необходимо подтвердить квалификацию',
    message:
      'По специализации "Инженер ПГС" требуется прохождение корпоративных тестов для подтверждения квалификации',
    type: 'error',
