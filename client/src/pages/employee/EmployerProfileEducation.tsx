  ...
  const [educations, setEducations] = useState<Education[]>([
    {
      ...
      description:
        'Специализация: Проектирование зданий и сооружений. Углубленное изучение расчета и проектирования железобетонных и металлических конструкций, BIM-моделирования. Магистерская диссертация: "Оптимизация конструктивных решений монолитных железобетонных каркасов высотных зданий с учетом прогрессирующего обрушения". Оценка: отлично.',
    ...
    },
    {
      ...
      description:
        'Профиль: "Промышленное и гражданское строительство". Основные дисциплины: строительная механика, железобетонные и металлические конструкции, основания и фундаменты, технология строительного производства. Бакалаврская работа: "Проектирование монолитного железобетонного каркаса 18-этажного жилого здания". Средний балл: 4.8.',
    ...
    {
      id: '3',
      institution: 'Центр строительного образования и экспертизы',
      degree: 'Повышение квалификации',
      fieldOfStudy: 'Расчет зданий и сооружений на сейсмические воздействия',
      description:
        'Программа повышения квалификации (72 часа) по расчету и проектированию сейсмостойких зданий. Изучение нормативных требований СП 14.13330, динамического расчета конструкций, особых требований к конструированию железобетонных элементов в сейсмических районах. Итоговая аттестация с отличием.',
