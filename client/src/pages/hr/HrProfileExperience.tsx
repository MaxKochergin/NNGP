...
function EmployerProfileExperience() {
  ...
  const [experiences, setExperiences] = useState<WorkExperience[]>([
    {
      id: '1',
      company: 'ООО "Эксперт-Рекрутинг"',
      position: 'HR-менеджер',
      description:
        'Подбор технических специалистов для строительных компаний. Проведение первичных и технических интервью с кандидатами. Взаимодействие с руководителями технических отделов по описанию вакансий и требований к кандидатам. Участие в разработке системы оценки компетенций инженеров.',
    ...
    },
    {
      ...
      description:
        'Руководство отделом подбора персонала (3 человека). Разработка и внедрение программы адаптации новых сотрудников. Организация корпоративного обучения для инженерно-технического персонала. Создание системы оценки эффективности персонала. Управление HR-аналитикой и отчетностью. Участие в стратегическом планировании развития компании.',
