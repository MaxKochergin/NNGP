          ...
          <Grid container spacing={3}>
              ...
              <Card sx={{ bgcolor: 'background.default', mb: 2 }}>
                <CardContent>
                  ...
                  <Typography
                    ...
                    sx={{ display: 'block', mt: 1 }}
                  >
                    Получать уведомления о новых тестах, результатах и изменениях на email
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            <Grid item xs={12}>
              ...
              <FormControlLabel
                ...
                label="Новые назначенные тесты"
              />
              <FormControlLabel control={<Switch defaultChecked />} label="Результаты тестов" />
              <FormControlLabel control={<Switch defaultChecked />} label="Обновления профиля" />
              <FormControlLabel control={<Switch defaultChecked />} label="Системные уведомления" />
            </Grid>
